...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Returns the group of libraries at kakao
     */
    public KakaoLibraryAccessors getKakao() { return laccForKakaoLibraryAccessors; }
    ...
    public static class AndroidxComposeMaterialLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public AndroidxComposeMaterialLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getExtended() { return create("androidx.compose.material.extended"); }
    ...
    public static class FirebaseAuthLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public FirebaseAuthLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for ui (com.firebaseui:firebase-ui-auth)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getUi() { return create("firebase.auth.ui"); }
    ...
    public static class GoogleServiceLibraryAccessors extends SubDependencyFactory {
        ...
        public GoogleServiceLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for playservice (com.google.android.gms:play-services-auth)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getPlayservice() { return create("google.service.playservice"); }
    ...
    public static class KakaoLibraryAccessors extends SubDependencyFactory {
        ...
        public KakaoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for user (com.kakao.sdk:v2-user)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getUser() { return create("kakao.user"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kakao (2.11.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class GoogleVersionAccessors extends VersionFactory  {
        ...
        public GoogleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: google.service (17.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getService() { return getVersion("google.service"); }
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        public BundleAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a dependency bundle provider for kakao which is an aggregate for the following dependencies:
             * <ul>
             *    <li>com.kakao.sdk:v2-user</li>
             * </ul>
             * This bundle was declared in catalog libs.versions.toml
             */
            public Provider<ExternalModuleDependencyBundle> getKakao() { return createBundle("kakao"); }
